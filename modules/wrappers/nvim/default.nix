  ...
  wrappers.nvim = let
    neovim = pkgs.neovimUtils.makeNeovimConfig {
      ...
      plugins = let
        ...
        ;
      in [
        { plugin = git-conflict-nvim; config = null; optional = false; }
        { plugin = kanagawa-nvim; config = null; optional = false; }
        { plugin = bufferline-nvim; config = null; optional = false; }
        { plugin = telescope-nvim; config = null; optional = false; }
      ];
    };
  in {
